...
namespace Basilisque.CodeAnalysis.Syntax
{
        ...
        where TCompilationInfo : CompilationInfo<TCompilationInfo>
    {
        ...
        protected override void ToCSharpString(StringBuilder sb, int indentLvl, int childIndentLvl, int indentCharCnt, int childIndentCharCnt)
        {
            ...
            if (hasNamespace)
                addNamespaceBegin(sb);

            bool addEmptyLineForNextClass = addClasses(sb, indentLvl, childIndentLvl, indentCharCnt, hasNamespace, _writeFileScopedNamespace);

            if (hasNamespace && !_writeFileScopedNamespace)
                addNamespaceEnd(sb, addEmptyLineForNextClass);
        ...
        private void addGeneratedCodeAttributes(StringBuilder sb)
        {
        ...
        private void addNamespaceBegin(StringBuilder sb)
        {
        ...
        private static void addNamespaceEnd(StringBuilder sb, bool addEmptyLine)
        {
            if (addEmptyLine)
                sb.AppendLine();
            sb.Append("}");
        ...
        private bool addClasses(StringBuilder sb, int indentLvl, int childIndentLvl, int indentCharCnt, bool hasNamespace, bool addEmptyLineForNextClass)
        {
            if (_classes is null)
                return addEmptyLineForNextClass;
